...
<div class="col-sm-5">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            echo form_open('rumahsakit/input');
            ?>
            
            <div class="form-group">
                <label>Nama Rumah Sakit</label>
                <input name="nama_rs" placeholder="Nama Rumah Sakit" value="<?=set_value('nama_rs') ?>" class="form-control" />
            </div>
            <div class="form-group">
                <label>Alamat</label>
...
<!-- <link rel="stylesheet" ype="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/leaflet.draw/1.0.4/leaflet.draw.css"> -->
...
if (curLocation[0]==0 && curLocation[1]==0) {
	curLocation =[-6.748200, 111.036676];	
}

var mymap = L.map('mapid').setView([-6.748200, 111.036676], 17);
